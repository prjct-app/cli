...
prjct is a **100% local, privacy-first** project management tool. We take your privacy seriously - in fact, we don't collect ANY of your data.
...
- You can inspect everything - it's just text files
...
- GitHub Pages may collect basic access logs per their [privacy policy](https://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement)
...
We may update this Privacy Policy. Changes will be posted on our GitHub repository with the update date.

## Children's Privacy

prjct is a developer tool not intended for children under 13. We don't knowingly collect information from children (we don't collect information from anyone!).
...
- **Portability**: Copy your `.prjct` folder anywhere
- **Control**: You decide what happens with your data

## Contact

For privacy questions, please open an issue on our [GitHub repository](https://github.com/jlopezlira/prjct-cli/issues).

## Summary

**TL;DR: We don't want your data. We don't collect your data. Everything stays on your computer. You're in complete control.**
