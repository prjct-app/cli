# CHANGELOG archive (v1.x and earlier)

Historical reference. Active releases live in [CHANGELOG.md](./CHANGELOG.md). Full release history is also visible via git tags.
