...
export const ForIndies = () => {
 return (
  <Section
   ...
   title={<>For Creators Who <span className="hunt-glow">Ship</span></>}
   subtitle={<>No project managers. No scrum masters. No ceremonies.<br />Just you, your AI, and shipping features that matter.</>}
   centered
   maxWidth="6xl"
  >
