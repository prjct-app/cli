...
const variants = {
 ...
 gradient: 'bg-gradient-to-r from-cat-light-mauve from-purple-500 to-cat-light-sapphire to-blue-500 text-white hover:from-cat-light-mauve/90 hover:from-purple-600 hover:to-cat-light-sapphire/90 hover:to-blue-600',
}
