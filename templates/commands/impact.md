...
```bash
# The CLI loads shipped features, roadmap, PRDs, and outcomes from SQLite
prjct impact --json 2>/dev/null || echo '{"outcomes":[],"shipped":[]}'
```
...
# The CLI saves outcome to SQLite and updates aggregates automatically
# PRD outcomes are also updated by the CLI
```

---

## Step 10: Persist and Output

# The CLI generates context files and logs events automatically
