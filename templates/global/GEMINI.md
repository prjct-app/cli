...
Crew (opt-in via `prjct crew install`): Leader (cyan) · Implementer (green) · Reviewer (red). Subagent dispatch is Claude-Code-only; in Gemini, identify the role you are playing explicitly.
