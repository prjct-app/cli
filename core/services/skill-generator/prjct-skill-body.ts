...
export function buildPrjctSkillBody(ctx: SkillContext): string {
  return [
    ...
    'The last four are the **sovereign knowledge base** — model-agnostic project knowledge (who you are, voice, terms, frameworks) any rig reads on demand. Capture with `prjct remember <facet>`, recall with `prjct context memory <facet>`; it is projected to the vault and pulled when needed, never injected into CLAUDE.md / AGENTS.md.',
    '',
    '### Data paths',
    '',
