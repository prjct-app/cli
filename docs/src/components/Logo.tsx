...
export const PrjctLogo = ({ showText = true, size = 'md' }: PrjctLogoProps) => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          'relative flex items-center justify-center rounded-lg border border-border bg-foreground shadow-sm text-background',
          logoSize[size]
        )}
      ...
      >
        <p
          className={cn(
            'mb-0.5 inline-block font-bold leading-none',
            textSize[size]
          )}
        >
          p/
