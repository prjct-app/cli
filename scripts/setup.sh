...
echo ""
echo -e "  ${BOLD}2.${NC} Start or inspect tracked work:"
echo -e "     ${DIM}Terminal:${NC}     ${GREEN}prjct task \"build auth\"${NC}"
echo -e "     ${DIM}Claude Code:${NC}  ${GREEN}p. task \"build auth\"${NC}"
echo ""
